# Requirements Archive: v1.1 Content & Reach
...
- [x] **PODCAST-01**: `/podcast/archive` lists all past audio briefings with date, play button, and design-token-consistent styling (depends on INFRA-01)
